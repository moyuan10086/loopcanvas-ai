...
import { normalizeVideoFrameMode, videoFrameModeLabel } from "@/lib/video-frame-mode";
    ...
    return (
        <div className="flex h-full w-full cursor-move flex-col px-3 pb-3 pt-7 text-sm" style={{ color: theme.node.text }} onWheel={(event) => event.stopPropagation()}>
            ...
            <div className="mb-2 flex flex-wrap gap-1.5">
                ...
                <InputChip label={mode === "video" ? videoFrameModeLabel(config.videoFrameMode, isSeedanceVideoConfig(config)) : "参考图"} value={`${inputSummary.imageCount} 张`} style={chipStyle} />
