...
import { videoFrameModeLabel } from "@/lib/video-frame-mode";
            ...
            <span ref={buttonRef} className="inline-flex min-w-0">
                ...
                >
                    <span className="truncate">
                        {videoFrameModeLabel(config.videoFrameMode, isSeedanceVideoConfig(config))} · {videoResolutionLabel(config.vquality, modelOptionName(config.model || config.videoModel))} · {videoSizeLabel(config.size)} · {videoSecondsLabel(config.videoSeconds, modelOptionName(config.model || config.videoModel))}
                    </span>
                </Button>
            </span>
            {panel}
